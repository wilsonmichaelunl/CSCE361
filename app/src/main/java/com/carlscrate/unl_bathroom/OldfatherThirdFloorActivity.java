...
public class OldfatherThirdFloorActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView img = (ImageView)findViewById(R.id.oldfather_third_imageView);
        ...
        AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> listView,
                ...
                switch (position) {
                    ...
                    case 1:
                        Intent intent = new Intent(OldfatherThirdFloorActivity.this, OldfatherMen1Activity.class);
                        startActivity(intent);
                        break;
